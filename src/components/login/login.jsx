...
function Login({modelValue, onModelValue, onLogin}) {
    ...
    useEffect(() => {
        ...
        const checkQrCode = async () => {
            ...
            let key = localStorage.getItem("unikey") || "";
            const {code, nickname, avatarUrl} = await httpGet(`/login/qr/check?key=${key}`);
    ...
    return (
        <>
            {modelValue && <div className="login">
                <div
                            ...
                            <form onSubmit={(event) => handleSubmit(event, 'qrcode')}>
                                ...
                                <div className="mx-20">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        {Tips.avatarUrl && <Avatar className="mb-10" src={Tips.avatarUrl}/>}
                        ...
                        <div className="overlay-container">
                            <div className="overlay">
                                <div className="overlay-panel overlay-left">
                                    ...
                                    <button className="ghost" id="signIn" onClick={() => ckBtn('qrcode')}>
                                        二维码登录
                                    </button>
                                </div>
                                <div className="overlay-panel overlay-right">
                                    ...
                                    <button className="ghost" id="signUp" onClick={() => ckBtn('captcha')}>
                                        验证码登录
                                    </button>
                                </div>
                            </div>
