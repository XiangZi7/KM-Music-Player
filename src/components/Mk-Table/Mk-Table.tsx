                        ...
                        <svg viewBox="0 0 52 52">
                            <g xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    fill="#061e26" data-original="#393687"></path>
                                <path
                                    ...
                                    fill="#c1dbe6" data-original="#89d3ff"></path>
                            </g>
                        </svg>
                        Photoshop
                    </div>
                    ...
                    <div className="products">
                        <svg viewBox="0 0 52 52">
                            <g xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M40.824 52H11.176C5.003 52 0 46.997 0 40.824V11.176C0 5.003 5.003 0 11.176 0h29.649C46.997 0 52 5.003 52 11.176v29.649C52 46.997 46.997 52 40.824 52z"
                                    fill="#261400" data-original="#6d4c13"></path>
                                <path
                                    ...
                                    fill="#e6d2c0" data-original="#ffbd2e"></path>
                            </g>
                        </svg>
                        Illustrator
                    </div>
        ...
        Update Available</span>
                    <div className="button-wrapper">
                        ...
                        <div className="pop-up">
                            ...
                            <div className="pop-up__subtitle">Adjust your selections for advanced options as desired
                    ...
                    <div className="products">
                        <svg viewBox="0 0 52 52">
                            <g xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M40.824 52H11.176C5.003 52 0 46.997 0 40.824V11.176C0 5.003 5.003 0 11.176 0h29.649C46.997 0 52 5.003 52 11.176v29.649C52 46.997 46.997 52 40.824 52z"
                                    fill="#3a3375" data-original="#3a3375"></path>
                                <path
                                    ...
                                    fill="#e4d1eb" data-original="#e7adfb"></path>
                            </g>
                        </svg>
                        After Effects
                    </div>
