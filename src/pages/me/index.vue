    ...
    <div class="page-container">
        <div class="app">
            <div class="card bg">
                ...
                <div class="content">
                    <yxcr-show-img defImg="2" class="avatar"
                        :src="userinfo.profile?.avatarUrl + '?param=90y90'"></yxcr-show-img>
            ...
            <div class="card">
                ...
                <div class="song-list">
                    <div class="song-item" v-for="song in playlist" :key="song.id"
                        ...
                        <img class="song-cover" :src="song.coverImgUrl + '?param=40y40'" alt="封面" />
                        <div class="song-info">
